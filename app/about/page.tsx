...
export default function AboutPage() {
  ...
  name: "Prajval Arora",
  role: "Founder & CEO",
  bio: "Creative and visionary explorer with a passion for shaping impactful ideas into tangible innovations. Expert in robotics, web development, and leadership-driven team building.",
  image: "https://media.licdn.com/dms/image/v2/D5603AQEy8xzTlD3o4A/profile-displayphoto-shrink_400_400/B56ZVq4IhhHsAk-/0/1741254855303?e=1755734400&v=beta&t=vLu722NNmmBCGK8ict331iY0rIjQ1oYleyn1pUlh3wQ",
  skills: ["Creative Designing", "Robotics", "Web Development", "Leadership"],
  achievements: [
    "Launched Tapri for teenpreneurs",
    "Mentored 100+ students globally",
    "Initiated multiple MVPs in AI and EdTech",
    "Built communities serving 300+ students"
  ],
  linkedin: "https://linkedin.com/in/prajvaldesignsmachines",
  insta: "https://www.instagram.com/prajval_designs_machines",
  location: "Kanpur, Uttar Pradesh",
  joinedDate: "2025-03-21",
},
{
  id: "founding team-coo",
  name: "Drishti Arora",
  role: "Co-Founder & COO",
  bio: "Imaginative and genius leader with a sharp sense for operations and soft skills. Robotics enthusiast and natural orator shaping the organizational flow.",
  image: "/images/drishti-arora.jpeg",
  skills: ["Robotics", "Soft Skills", "Oration", "Leadership"],
  achievements: [
    "Co-led Tapri from MVP to product",
    "Public speaker at tech youth events",
    "Managed operations across 3+ cities",
    "Built automation pipelines for community tasks"
  ],
  linkedin: "https://linkedin.com/in/drishtiarora",
  twitter: "",
  location: "Ludhiana, Punjab",
  joinedDate: "2025-04-05",
},
{
  id: "founding team -tech-ops-lead",
  name: "Shaurya Gupta",
  role: "Technical and Operations Lead",
  bio: "A driven and detail-oriented tech leader with expertise in robotics, IoT systems, and computer vision. Known for designing efficient, real-world solutions and managing cross-functional teams with operational excellence. Guided by the motto: 'It is never good until you make it good.'",
  image: "/images/shaurya-gupta.jpeg", // Replace with actual image path if available
  skills: [
    "Robotics",
    "IoT",
    "Arduino",
  ...
  achievements: [
    "Led IoT-based automation project with real-world deployment",
    "Built and managed Tapri’s entire tech operation flow",
    "Developed CV-based prototype for security systems",
    "Managed 10+ projects across distributed tech teams"
  ],
  linkedin: "https://www.linkedin.com/in/guptshaurya/",
  twitter: "",
  location: "Cardiff, UK",
  joinedDate: "2025-04-01",
},
{
  id: "advisor-strategist",
  name: "Krishna Pathak",
  role: "Advisor",
  bio: "Strategic mind with a sharp debate instinct and business insight. Helps steer Tapri’s mission through smart decisions and leadership training.",
  image: "/images/krishna-pathak.jpeg",
  skills: ["Debate", "Strategy Development", "Business Management"],
  achievements: [
    "Won multiple national debate championships",
    "Guided business pivots in early-stage phase",
    "Crafted Tapri’s equity and payment strategy"
  ],
...
{
  id: "career-counseling-head",
  name: "Aarya Gupta",
  role: "Head of Career & College Counseling – India",
  bio: "Empathetic and purpose-driven mentor guiding students through career choices, entrance exams, and college admissions. Passionate about building clarity and confidence in every learner’s journey.",
  image: "/images/aarya-gupta.jpeg", // Use actual path if you have one
  skills: [
  ...
  achievements: [
    "Guided 200+ students toward top-tier universities",
    "Designed Tapri’s counseling module for teens",
    "Led workshops across 10+ schools",
    "Built student roadmaps using hybrid counseling models"
  ],
  linkedin: "https://www.linkedin.com/in/aarya-gupta-ag200308",
  twitter: "",
